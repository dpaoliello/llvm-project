  ...
  if (TT.isOSBinFormatMachO()) {
    ...
    if (Subtarget->isThumb() && Subtarget->hasVFP2Base() &&
      ...
      static const struct {
        ...
        { RTLIB::ADD_F32, RTLIB::lci___addsf3vfp },
        { RTLIB::SUB_F32, RTLIB::lci___subsf3vfp },
        { RTLIB::MUL_F32, RTLIB::lci___mulsf3vfp },
        { RTLIB::DIV_F32, RTLIB::lci___divsf3vfp },

        // Double-precision floating-point arithmetic.
        { RTLIB::ADD_F64, RTLIB::lci___adddf3vfp },
        { RTLIB::SUB_F64, RTLIB::lci___subdf3vfp },
        { RTLIB::MUL_F64, RTLIB::lci___muldf3vfp },
        { RTLIB::DIV_F64, RTLIB::lci___divdf3vfp },

        // Single-precision comparisons.
        { RTLIB::OEQ_F32, RTLIB::lci___eqsf2vfp },
        { RTLIB::UNE_F32, RTLIB::lci___nesf2vfp },
        { RTLIB::OLT_F32, RTLIB::lci___ltsf2vfp },
        { RTLIB::OLE_F32, RTLIB::lci___lesf2vfp },
        { RTLIB::OGE_F32, RTLIB::lci___gesf2vfp },
        { RTLIB::OGT_F32, RTLIB::lci___gtsf2vfp },
        { RTLIB::UO_F32,  RTLIB::lci___unordsf2vfp },

        // Double-precision comparisons.
        { RTLIB::OEQ_F64, RTLIB::lci___eqdf2vfp },
        { RTLIB::UNE_F64, RTLIB::lci___nedf2vfp },
        { RTLIB::OLT_F64, RTLIB::lci___ltdf2vfp },
        { RTLIB::OLE_F64, RTLIB::lci___ledf2vfp },
        { RTLIB::OGE_F64, RTLIB::lci___gedf2vfp },
        { RTLIB::OGT_F64, RTLIB::lci___gtdf2vfp },
        { RTLIB::UO_F64,  RTLIB::lci___unorddf2vfp },

        // Floating-point to integer conversions.
        // i64 conversions are done via library routines even when generating VFP
        // instructions, so use the same ones.
        { RTLIB::FPTOSINT_F64_I32, RTLIB::lci___fixdfsivfp },
        { RTLIB::FPTOUINT_F64_I32, RTLIB::lci___fixunsdfsivfp },
        { RTLIB::FPTOSINT_F32_I32, RTLIB::lci___fixsfsivfp },
        { RTLIB::FPTOUINT_F32_I32, RTLIB::lci___fixunssfsivfp },

        // Conversions between floating types.
        { RTLIB::FPROUND_F64_F32, RTLIB::lci___truncdfsf2vfp },
        { RTLIB::FPEXT_F32_F64,   RTLIB::lci___extendsfdf2vfp },
        ...
        { RTLIB::SINTTOFP_I32_F64, RTLIB::lci___floatsidfvfp },
        { RTLIB::UINTTOFP_I32_F64, RTLIB::lci___floatunssidfvfp },
        { RTLIB::SINTTOFP_I32_F32, RTLIB::lci___floatsisfvfp },
        { RTLIB::UINTTOFP_I32_F32, RTLIB::lci___floatunssisfvfp },
      };
      // clang-format on
