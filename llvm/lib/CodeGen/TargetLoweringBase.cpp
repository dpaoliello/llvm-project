...
ISD::CondCode TargetLoweringBase::getSoftFloatCmpLibcallPredicate(
  ...
  switch (Impl) {
  case RTLIB::lci___aeabi_dcmpeq__une:
  case RTLIB::lci___aeabi_fcmpeq__une:
    // Usage in the eq case, so we have to invert the comparison.
    return ISD::SETEQ;
  case RTLIB::lci___aeabi_dcmpeq__oeq:
  case RTLIB::lci___aeabi_fcmpeq__oeq:
    // Normal comparison to boolean value.
    return ISD::SETNE;
  case RTLIB::lci___aeabi_dcmplt:
  case RTLIB::lci___aeabi_dcmple:
  case RTLIB::lci___aeabi_dcmpge:
  case RTLIB::lci___aeabi_dcmpgt:
  case RTLIB::lci___aeabi_dcmpun:
  case RTLIB::lci___aeabi_fcmplt:
  case RTLIB::lci___aeabi_fcmple:
  case RTLIB::lci___aeabi_fcmpge:
  case RTLIB::lci___aeabi_fcmpgt:
